                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-2 col-sm-3 col-4">
                                                            <div class="nav flex-column nav-pills " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                                <a class="nav-link active" id="product-1-tab" data-bs-toggle="pill" href="#product-1" role="tab" aria-controls="product-1" aria-selected="true">
                                                                    <img src="/storage/assets/images/{{$products->image}}" alt="" class="img-fluid mx-auto d-block rounded">
                                                                </a>
                                                        ...
                                                        <div class="col-md-7 offset-md-1 col-sm-9 col-8">
                                                            <div class="tab-content" id="v-pills-tabContent">
                                                                <div class="tab-pane fade show active" id="product-1" role="tabpanel" aria-labelledby="product-1-tab">
                                                                    <div>
                                                                        <img src="/storage/assets/images/{{$products->image}}" alt="" class="img-fluid mx-auto d-block">
                                                                    </div>
                                                                </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mt-4 mt-xl-3">
                                                    ...
                                                    <h4 class="mt-1 mb-3">{{$products->name}}</h4>
                                                    ...
                                                    <h5 class="mb-4">Price : <span class="text-muted me-2"><del>${{$products->discount}} USD</del></span> <b>${{$products->price}}</b></h5>
                                                    ...
                                                    <div class="product-color">
                                                        ...
                                                        <h5 class="font-size-15">{{$products->description}} :</h5>
                                                        p
